...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dr38lv00a/image/upload/v1741248530/xuzvstbpybs3s0ly47ew.png",
        width: 548,
        height: 253,
        alt: 'Image',
      },
        ...
        <div className="relative rounded-2xl bg-white/10 backdrop-blur-lg p-8 mb-12">
          <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              <Image 
                src="https://res.cloudinary.com/dr38lv00a/image/upload/v1741248530/xuzvstbpybs3s0ly47ew.png" 
                alt="Event Image" 
                width={400} 
                height={400} 
