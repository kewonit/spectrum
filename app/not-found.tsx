...
export default function FlappyBird() {
  ...
  useEffect(() => {
    const birdUrls = [
      'https://res.cloudinary.com/dqrmowcdh/image/upload/v1740830768/cfvqjq3gupspoky46xap.png',
      'https://res.cloudinary.com/dqrmowcdh/image/upload/v1740830768/cfvqjq3gupspoky46xap.png',
      'https://res.cloudinary.com/dqrmowcdh/image/upload/v1740830768/cfvqjq3gupspoky46xap.png',
    ]
    const numberUrls = [
    ...
    const messageUrl = 'https://res.cloudinary.com/dqrmowcdh/image/upload/v1741249336/zxp0x2l2orhmlqhiydxl.png'
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      ...
      />
      <p className="mt-4 text-white text-lg">Press Space to start/jump or click/tap the game area</p>
    </div>
  )
}